...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            # we expect 10 rows to be filtered
            1449,
        ),
    ),
)
def test_prediction_endpoint(api_endpoint, expected_no_predictions, client):
    ...
    if api_endpoint == "v1/predictions/lasso":
...
# parameterization allows us to try many combinations of data
...
def test_prediction_validation(field, field_value, index, expected_error, client):
    ...
    # Check gb_regressor.processing.validation import HouseDataInputSchema
